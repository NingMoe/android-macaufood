        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    View btn = item.findViewById(R.id.icon);
                    if (x < btn.getLeft()) break;
            ...
            if (vv.equals(first)) {
               if (mDragPos == mFirstDragPos) {
                   visibility = View.INVISIBLE;
                    ...
                    vv.findViewById(R.id.delete_btn).setVisibility(View.INVISIBLE);
                }
            } else if (i == childnum) {
