...
public class Menu extends BaseActivity {
	...
	private String getUrl() {
		return "http://www.cycon.com.mo/xml_menu.php?id=" + menuid + "&page=" + currentPage + "&udid=android-" + Config.DEVICE_ID;
	}
	
	private void setHeaderText() {
		header.setText("菜單 " + currentPage + "/" + totalPages + " ~ " + getIntent().getStringExtra("name"));
	}
