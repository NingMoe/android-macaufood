...
public class MFConfig {
	...
	public static String cafe_version_update = "1395296896";
	
	public static String memberId;
	public static String memberName;
	
	public static boolean hasAlreadyRefreshList = false;
	...
	private Map<String, ParsedPSHolder> psInfoMap = new HashMap<String, ParsedPSHolder>();
	...
	public ArrayList<String> getPsHotList() {
		return psHotList;
	}
	public ArrayList<String> getFriendsActivityList() {
		return mFriendsActivityInfo;
	}
	public Map<String, ParsedPSHolder> getPsInfoMap() {
		return psInfoMap;
	}
