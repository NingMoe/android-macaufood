	...
	public static void initDataFromXml(Resources res, Context context) {
		...
		Config.getInstance().getCafeLists().clear();
			...
			try {
				...
				ETLog.e("Config", "NotFoundexception");
				e.printStackTrace();
			} catch (FactoryConfigurationError e) {
				ETLog.e("Config", "factoryconfiexception");
				e.printStackTrace();
			} catch (ParserConfigurationException e) {
				ETLog.e("Config", "parseconfexception");
				e.printStackTrace();
			} catch (SAXException e) {
				ETLog.e("Config", "saxexception");
				e.printStackTrace();
			} catch (IOException e) {
				ETLog.e("Config", "ioexception");
				e.printStackTrace();
			}
	}
